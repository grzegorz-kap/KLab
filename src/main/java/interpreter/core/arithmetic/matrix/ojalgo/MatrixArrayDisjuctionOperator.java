...
import interpreter.types.NumberCreator;
...
public class MatrixArrayDisjuctionOperator<N extends Number> extends OjalgoOperator<N> {
	private NumberCreator<N> creator;

	public MatrixArrayDisjuctionOperator(OjalgoMatrixCreator<N> creator, NumberCreator<N> scalarCreator) {
		super(creator);
